...
ralph_status() {
  ...
  printf '%-15s %s\n' "started_at:"     "$(_ralph_status_fmt "$(_ralph_status_json_val "$f" "started_at")")"
  printf '%-15s %s\n' "updated_at:"     "$(_ralph_status_fmt "$(_ralph_status_json_val "$f" "updated_at")")"
  printf '%-15s %s\n' "iteration:"      "$(_ralph_status_fmt "$(_ralph_status_json_val "$f" "iteration")")"
