...
| 当前 iteration 设计 | 待定 | 待启动 | I3 尚未排序；用户确定主题后创建 `requirements/ralph-loop/I3-design.md` |
| Iteration 归档 | `requirements/ralph-loop/I1-FINAL-TASK.md` / `requirements/ralph-loop/I2-FINAL-TASK.md` / `requirements/ralph-loop/I<N>-FINAL-TASK.md` | 历史 | iteration 完成后的不可变任务快照（cp 自 `.ralph/TASKS.md`） |
...
| 当前 iteration 设计方案 | `.ralph/TASKS.md` 的当前迭代声明；I3 设计待用户排序后创建 |
